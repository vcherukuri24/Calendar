...
//        self.topLineView = [[UIView alloc]initWithFrame:CGRectMake(-1, 0, frame.size.width + 2, 1)];
        ...
        _dotView = [[UIView alloc] initWithFrame:CGRectMake(21, 19, 4.0, 4.0)];
        [_dotView setBackgroundColor:[UIColor purpleColor]];
        [_dotView.layer setCornerRadius:2.0];
        ...
        [self.viewForBaselineLayout addSubview:_dotView];
